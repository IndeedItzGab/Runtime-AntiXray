...
- Download the latest pack in [CurseForge](https://www.curseforge.com/minecraft-bedrock/scripts/runtime-antixray).
...
- **New World Method**
  ...
  - Edit or Create a new file with the name "world_behavior_packs.json" inside the world with Beta APIs enabled.
    ...
    [
      {
        "pack_id": "fb175c55-4716-427f-abfe-1d585d5c0d9b",
        "version": [ 1, 0, 0 ]
      }
    ]
    ```